...
export default function EnquiryPage() {
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50">
      {/* Header */}
      <div className="border-b border-gray-200 pb-5 mb-8 bg-white px-6 pt-6">
        ...
        <p className="mt-2 text-sm text-gray-600">
          Capture lead information during phone calls. Required fields are marked with *
        </p>
      </div>

      {/* Success Message */}
      {showSuccessMessage && (
        <div className="mx-6 mb-6 p-4 bg-green-100 border border-green-300 text-green-700 rounded-lg flex items-center gap-2">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-8">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {renderSelectField('leadType', 'Lead Type', LEAD_TYPE_OPTIONS, true)}
                {formData.leadType === 'other' && (
                  renderInputField('customLeadType', 'Specify Lead Type', 'text', 'Enter lead type', true)
                )}
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {renderInputField('address', 'Address', 'text', 'Enter complete address (if available)', false, <MapPin className="w-4 h-4 text-gray-400" />)}
