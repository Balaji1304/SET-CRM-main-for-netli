...
const NotificationsPage = () => {
  ...
  return (
    <div className="flex flex-col h-full lg:min-h-screen lg:bg-gray-50">
      {/* Header Section - Responsive Design */}
      <div className="lg:bg-white lg:border-b lg:border-gray-200">
        {/* Mobile Header */}
        ...
        {/* Desktop Header */}
        <div className="hidden lg:block border-b border-gray-200 pb-5 mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
      ...
      <div className="lg:bg-white lg:rounded-lg lg:border lg:border-gray-200 lg:shadow-sm flex-1 flex flex-col lg:overflow-hidden">
        {/* Mobile Content */}
        <div className="lg:hidden max-w-4xl mx-auto px-4 py-4 w-full">
          {/* Search Bar */}
          <div className="mb-4">
        ...
        {/* Desktop Filter and Action Bar */}
        <div className="hidden lg:block p-4 md:p-6 border-b border-gray-200 sticky top-0 bg-white z-20">
          {/* Main Controls Row */}
          <div className="flex flex-col xl:flex-row gap-3 xl:gap-4 xl:items-center">
            ...
            <div className="relative xl:w-80">
              ...
              <input
                ...
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-sm transition-colors"
              />
            </div>

            {/* Right Side - Filters and Actions */}
            <div className="flex flex-col sm:flex-row gap-3 xl:flex-1 xl:justify-between">
              {/* Filter Controls */}
              <div className="flex flex-wrap gap-2 sm:gap-3">
                <div className="relative">
                  <select
                    value={filterType}
                    onChange={(e) => setFilterType(e.target.value)}
                    className="appearance-none bg-white border border-gray-300 rounded-lg px-4 py-2.5 pr-10 text-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none min-w-[140px]"
                  >
                ...
                <div className="relative">
                  <select
                    ...
                    className="appearance-none bg-white border border-gray-300 rounded-lg px-4 py-2.5 pr-10 text-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none min-w-[120px]"
                  >
                ...
                <button
                  onClick={() => setShowUnreadOnly(!showUnreadOnly)}
                  className={`px-4 py-2.5 rounded-lg text-sm font-medium transition-colors min-w-[100px] ${
                    showUnreadOnly 
          ...
          {(filterType !== 'all' || priorityFilter !== 'all' || showUnreadOnly) && (
            <div className="flex items-center justify-between bg-blue-50 border border-blue-200 rounded-lg px-3 py-2 mt-4">
              <div className="flex items-center space-x-2">
                <Filter className="w-4 h-4 text-blue-600" />
                <span className="text-sm font-medium text-blue-800">
                  {[
                    filterType !== 'all' && getRoleSpecificTypes(user?.role).find(t => t.value === filterType)?.label,
        ...
        {/* Notifications Content - Responsive */}
        <div className="flex-1 lg:overflow-hidden">
          <div className="lg:h-full lg:overflow-y-auto lg:p-4 lg:md:p-6">
                ...
                <div className="space-y-0">
                  {filteredAndSortedNotifications.map((notification) => (
                    <div
                      key={notification._id}
                      className={`
                        bg-white border border-gray-200 rounded-lg hover:shadow-md transition-all cursor-pointer mb-3
                        ${!notification.read ? 'border-orange-200 bg-orange-50/30' : ''}
                      `}
                      onClick={() => handleNotificationClick(notification)}
                    >
                      <div className="flex items-start px-6 py-5 gap-4">
                        {/* Desktop notification content - larger and more detailed */}
                        <div className="flex-shrink-0">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex-1 min-w-0 pr-4">
                              <h3 className={`text-base font-semibold ${!notification.read ? 'text-gray-900' : 'text-gray-700'} mb-2`}>
                                {notification.title}
                              </h3>
